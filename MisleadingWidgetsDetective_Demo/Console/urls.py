...
urlpatterns = [
    ...
    path('submitdropproject/<str:project_name>/<str:subtask_name>',views.submitDropProject),
    ...
    path('savecoverlist',views.saveCoverList),
    ...
    path('resovlecoverlist',views.resovleCoverList),
    path('viewclusters/<str:project_name>/<str:subtask_name>',views.viewClusters),

    # Gallerys
    ## Console/gallerys.html
    path('gallerys',views.gallerys), 

    ## Console/datasets.html
    path('datasets',views.dataSets), 
    path('createdataset/<str:database>',views.createDataSetByChoicen),
    path('submitdatasetchoicen/<str:database>',views.submitDataSetChoicen),
