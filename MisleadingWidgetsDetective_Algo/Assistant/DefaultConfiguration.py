...
def initConfig(instanceName='',no=1):
    ...
    # 脚本所在地
    'SCRIPT_ROOT':'/home/dl/users/wangruifeng/05MisleadingWidgets/androidwidgetclustering/',
    # 源数据根目录
    #'RAW_ROOT':'/data/NewStaticWidgetData/raw_data/',
    'RAW_ROOT':'/data/wangruifeng/datasets/DroidBot_Epoch/raw_data/',
    # 生成数据根目录
    'GENERATED_ROOT':'/data/wangruifeng/datasets/DroidBot_Epoch/generated_data/',
    ...
    # API白名单，避免第三方API混入
    'WHITE_API_LIST_PATH':'dimension_data/androidPlatformAPI326',#TTT
    # SPM训练的码本
    'SPM_CODE_BOOK_PATH':'pretrain_data/SPMCodeBook-l2-c1000',
    ...
    'API_IDF_PATH':'DimensionEngineering/APIIDF', #multi-supported 必须保存在本地，是pro之一，特征之一
    ...
    'SCRIPT_ROOT':'/home/dl/users/wangruifeng/05MisleadingWidgets/androidwidgetclustering/',
    # 源数据根目录
    'RAW_ROOT':'/data/wangruifeng/datasets/NewStaticWidgetData/raw_data/',
    # 生成数据根目录
    'GENERATED_ROOT':'/data/wangruifeng/datasets/NewStaticWidgetData/generated_data/',
    ...
    'PICTURES_TRASH_DIR':'trash_data/',
    # API白名单，避免第三方API混入
    'WHITE_API_LIST_PATH':'dimension_data/androidPlatformAPI226.txt',
    # SPM训练的码本
    ...
    for key,value in config.items():
        ...
        # 基本配置不改
            ...
            continue
        # raw 数据，添加raw root
        elif key == 'INPUT_DATA_DIR' or key == 'PICTURES_TRASH_DIR':
            config[key] = config['RAW_ROOT'] + '#' + value
        elif key == 'INPUT_DATA_DIR' or key == 'UNIVERSAL_RECORDS_PATH' or key == 'UNIVERSAL_RECORDS_DIR' or key == 'WHITE_API_LIST_PATH' or key == 'PICTURES_DIR' or key == 'PICTURES_TRASH_DIR' or key == 'SPM_CODE_BOOK_PATH':
            config[key] = config['RAW_ROOT'] + value
